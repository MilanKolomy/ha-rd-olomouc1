"""
Smaže starý dashboard a vytvoří nový s url_path 'home'.
Pak znovu nahraje lovelace config.
Spustit na HA: python3 /tmp/recreate_dashboard.py
"""
import socket, struct, os, json, base64, yaml
...
YAML_FILE = '/tmp/lovelace_new.yaml'
...
# Smazat starý dashboard
send_frame({'id': 1, 'type': 'lovelace/dashboards/delete', 'dashboard_id': 'dashboard_dashboard'})
msg = recv_frame()
print('3) delete:', msg)

# Vytvořit nový s url_path 'home'
send_frame({
    'id': 2,
