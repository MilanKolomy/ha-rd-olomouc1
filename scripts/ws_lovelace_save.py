"""
Aktualizuje Lovelace config custom dashboardu přes HA WebSocket API.
Spustit na HA: python3 /tmp/ws_lovelace_save.py
"""
import socket, struct, os, json, yaml
...
while b'\r\n\r\n' not in buf:
    buf += s.recv(4096)
# keep any WS frame data that arrived with the HTTP response
